...
public class BlurBorderFragment2 extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BorderImageSetterClass.setBorderImage(R.drawable.images3);
                getActivity().setContentView(R.layout.blur_border_layout3);
            }
        });
