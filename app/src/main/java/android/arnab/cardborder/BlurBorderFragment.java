...
public class BlurBorderFragment extends Fragment
{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        nxt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BorderImageSetterClass.setBorderImage(R.drawable.images2);
                getActivity().setContentView(R.layout.blur_border_layout2);
            }
        });
